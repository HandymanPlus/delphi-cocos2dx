...
type
   ...
   public
      ...
      procedure Destroy(pc: Pb2Contact); reintroduce; overload;
      procedure Collide;
   end;
...
procedure b2TimeOfImpact(var output: Tb2TOIOutput; const input: Tb2TOIInput);
...
function Tb2WorldQueryWrapper.RayCastCallback(const input: Tb2RayCastInput;
...
function Tb2WorldRayCastWrapper.QueryCallback(proxyId: Int32): Boolean;
begin
  Result := False;
end;
...
function Tb2ContactListener.QueryCallback(proxyId: Int32): Boolean;
begin
  Result := False;
end;

function Tb2ContactListener.RayCastCallback(const input: Tb2RayCastInput;
  proxyId: Int32): PhysicsFloat;
begin
  Result := 0;
end;
...
begin
   ...
   //height1 := m_nodes[child1].height; {$MESSAGE 'Ã»ÓÐÓÃµ½?'}
   //height2 := m_nodes[child2].height; {$MESSAGE 'Ã»ÓÐÓÃµ½?'}
   //height := 1 + b2Max(height1, height2); {$MESSAGE 'Ã»ÓÐÓÃµ½?'}
...
function Tb2BroadPhase.RayCastCallback(const input: Tb2RayCastInput; proxyId: Int32): PhysicsFloat;
begin
  {.$MESSAGE '!!!'}
  Result := 0;
end;
